    ...
    <ul class="form">
        <li>
            ...
            <div class="fields">
                ...
                <?php echo wk_infoimg('Example: John Smith or Jane Smith')?>
            </div>
        </li>
        <li>
            ...
            <div class="fields">
                ...
                <?php echo wk_infoimg('This is where your completed Will is emailed - We will never share or sell your email address.')?>
            </div>
        </li>
        <li>
            ...
            <div class="fields">
                ...
                <?php echo wk_infoimg('Example: Accountant, Book Keeper, Retired, Home Maker, Plumber,...')?>
            </div>
        </li>
        <li>
            <label for="dob_day"><strong>Date of birth</strong> <span>*</span></label>
            <div class="fields">
                <?php echo wk_select_days('dob_day', '', 'id="dob_day"')?> -
                <?php echo wk_select_months('dob_month', '', 'id="dob_month"')?> -
                <?php echo wk_select_years('dob_year', '', 'id="dob_year"')?>
            </div>
        </li>
        <li>
            ...
            <div class="fields">
                ...
                <?php echo wk_infoimg('Example: Unit 12, 62 George Street')?>
            </div>
        </li>
        <li>
            ...
            <div class="fields">
                ...
                <?php echo wk_select_states('state', '', 'id="state"')?>
            </div>
        </li>
    </ul>
</form>